...
type IDependencies interface {
	...
	Block(opts ...any) (*ghw.BlockInfo, error)
	...
	GPU(opts ...any) (*ghw.GPUInfo, error)
	Memory(opts ...any) (*ghw.MemoryInfo, error)
	Chassis(opts ...any) (*ghw.ChassisInfo, error)
	PCI(opts ...any) (*ghw.PCIInfo, error)
...
func (d *Dependencies) Block(opts ...any) (*ghw.BlockInfo, error) {
	return ghw.Block(opts...)
}

func (d *Dependencies) Product(opts ...any) (*ghw.ProductInfo, error) {
...
func (d *Dependencies) GPU(opts ...any) (*ghw.GPUInfo, error) {
	return ghw.GPU(opts...)
}

func (d *Dependencies) Memory(opts ...any) (*ghw.MemoryInfo, error) {
	return ghw.Memory(opts...)
}

func (d *Dependencies) Chassis(opts ...any) (*ghw.ChassisInfo, error) {
	return ghw.Chassis(opts...)
}

func (d *Dependencies) PCI(opts ...any) (*ghw.PCIInfo, error) {
	return ghw.PCI(opts...)
}
