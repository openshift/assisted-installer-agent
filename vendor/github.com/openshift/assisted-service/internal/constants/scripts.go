...
echo "ETC_NETWORK_MANAGER was set to '$ETC_NETWORK_MANAGER'"
...
function map_host_macs_to_interfaces() {
  ...
  do
    ...
    echo "Found host to interface mapping mapping: host_macs_to_hw_iface['$mac']='$nic'"
  done
}
...
function set_logical_nic_mac_mapping() {
  echo "Checking '$mapping_file' for logic nic to mac mappings"
  ...
  do
    ...
    echo "Info: Found logical nic to mac mapping in file 'mapping_file' : logical_nic_mac_map['$nic']=${'mac'}"
  done
}
...
function update_interface_names_by_mapping_file() {
  echo "Info: Updaing logical interface name in nmconnection files with interface name from mapping files"
  ...
  do
    echo "Info: Updaing logical interface name in nmconnection files with interface name from mapping file '$nmconn_file'"
