...
type mockConstructorTestingTNewMockDomainResolutionDependencies interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewMockDomainResolutionDependencies(t mockConstructorTestingTNewMockDomainResolutionDependencies) *MockDomainResolutionDependencies {
