...
var _ = Describe("Interfaces", func() {
	...
	It("Single result", func() {
		interfaceMock := util.NewFilledMockInterface(1500, "eth0", "f8:75:a4:a4:00:fe", net.FlagBroadcast|net.FlagUp, []string{"10.0.0.18/24", "fe80::d832:8def:dd51:3527/128", "de90::d832:8def:dd51:3527/128"}, 1000, "physical")
