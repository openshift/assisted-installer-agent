...
func (_m *MockLogsSender) CreateFolderIfNotExist(folder string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for CreateFolderIfNotExist")
	}
...
func (_m *MockLogsSender) ExecuteOutputToFile(outputFilePath string, command string, args ...string) (string, int) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ExecuteOutputToFile")
	}

	var r0 string
	var r1 int
	if rf, ok := ret.Get(0).(func(string, string, ...string) (string, int)); ok {
		return rf(outputFilePath, command, args...)
	}
...
func (_m *MockLogsSender) ExecutePrivilegedToFile(outputFilePath string, command string, args ...string) (string, int) {
	...
	if len(ret) == 0 {
		panic("no return value specified for ExecutePrivilegedToFile")
	}
...
func (_m *MockLogsSender) FileUploader(filePath string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for FileUploader")
	}
...
func (_m *MockLogsSender) GatherErrorLogs(targetDir string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for GatherErrorLogs")
	}
...
func (_m *MockLogsSender) GatherInstallerLogs(targetDir string) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for GatherInstallerLogs")
	}
...
func (_m *MockLogsSender) LogProgressReport(progress models.LogsState) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for LogProgressReport")
	}
...
func NewMockLogsSender(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockLogsSender {
	mock := &MockLogsSender{}
