...
require (
	...
	github.com/openshift/assisted-service v1.0.10-0.20250331075838-9346359925be
...
replace (
	...
	github.com/openshift/assisted-service/api => github.com/openshift/assisted-service/api v0.0.0-20250331075838-9346359925be
	github.com/openshift/assisted-service/client => github.com/openshift/assisted-service/client v0.0.0-20250331075838-9346359925be
	github.com/openshift/assisted-service/models => github.com/openshift/assisted-service/models v0.0.0-20250331075838-9346359925be
