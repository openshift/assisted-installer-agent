...
func (_m *MockDependencies) MkdirAll(path string, perm os.FileMode) error {
...
func (_m *MockDependencies) WriteFile(filename string, data []byte, perm os.FileMode) error {
