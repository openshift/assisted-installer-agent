...
func (_m *MockDependencies) GetLastLeaseFromFile(log logrus.FieldLogger, fileName string) (string, string, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetLastLeaseFromFile")
	}

	var r0 string
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(logrus.FieldLogger, string) (string, string, error)); ok {
		return rf(log, fileName)
	}
...
func (_m *MockDependencies) LeaseInterface(log logrus.FieldLogger, masterDevice string, name string, mac net.HardwareAddr) (*net.Interface, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for LeaseInterface")
	}

	var r0 *net.Interface
	var r1 error
	if rf, ok := ret.Get(0).(func(logrus.FieldLogger, string, string, net.HardwareAddr) (*net.Interface, error)); ok {
		return rf(log, masterDevice, name, mac)
	}
