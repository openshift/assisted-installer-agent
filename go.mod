...
require (
	...
	github.com/openshift/api v0.0.0-20251118143053-b6fddd3c8174 // indirect
...
replace (
	...
	github.com/openshift/assisted-service => github.com/openshift/assisted-service v0.0.0-20260725012639-e1813a5b6827
